...
import { fetchSeeds, fetchSingleSeed } from "../../actions/Products";
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  {/* <a
                    ...
                    href="https://drive.google.com/file/d/1-8-1OUFaI9IMDIHE0RPBHvV2eQZunT1t/view?usp=sharing"
                    target="_blank"
                  >
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw fontSize1">Seeds</h1>
            <h3
              className="fontSize3"
              style={{ color: "#fff", fontSize: "1.8rem", marginTop: "1rem" }}
            >
              Quality seeds maintain their genetic purity with viability and
          ...
          <div className="container">
            <div className="gallery-filter mb-30 f1">
              <ul className="post-filter masonary text-center list-inline text-capitalize">
                ...
                <li className="filter active list" data-filter="Seeds">
