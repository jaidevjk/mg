...
class GrowthPromoters extends Component {
  state = {
    state: "",
    address: "",
    search: "",
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw fontSize1">Growth Promoters</h1>
            <h3
              className="fontSize3"
              style={{ color: "#fff", fontSize: "1.8rem", marginTop: "1rem" }}
            >
              External application of growth promoters has beneficial effects by
              enhancing crop yield by improving overall plant health.
            </h3>
          </div>
        </div>
          ...
          <div className="container">
            <div className="gallery-filter mb-30 f1">
              <ul className="post-filter masonary text-center list-inline text-capitalize">
                ...
                <li className="list filter active" data-filter="Plant">
                  <span className="fw-7">Plant Growth Regulator</span>
                </li>
              </ul>
              {/* <!-- /.post-filter --> */}
            </div>
