              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  <div className="enquiry">
                    <form
                      action="https://formsubmit.co/info.multiplexgroup@gmail.com"
                      autoComplete="off"
                      method="POST"
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw">Fertilizers</h1>
            <h3
              className="fontSize3"
              style={{ color: "#fff", fontSize: "1.8rem", marginTop: "1rem" }}
            >
              Balanced Major, Minor, Micro & Secondary nutrients hold its
              importance throughout Crop production and Nutrition.
            </h3>
          </div>
        </div>
          ...
          <div className="container">
            <div className="gallery-filter mb-30 f1">
              <ul className="post-filter masonary text-center list-inline text-capitalize">
                ...
                <li className="list active filter" data-filter="all">
                  <span className="fw-7">All</span>
                </li>
                <li className="list" data-filter="Major">
                  <span className="fw-7">Major Nutrients</span>
                </li>
                <li className="list" data-filter="Secondary">
                  <span className="fw-7">Secondary Nutrients</span>
                </li>
                <li className="list" data-filter="Micro">
                  <span className="fw-7">Micro Nutrients</span>
                </li>
                <li className="list" data-filter="Muti-Micronutrient">
                  <span className="fw-7">Muti-Micronutrient</span>
                </li>
                <li className="list" data-filter="Bio-stimulants">
                  <span className="fw-7">Bio-stimulants</span>
                </li>
              </ul>
              {/* <!-- /.post-filter --> */}
            </div>
