...
import { fetchAdjuvants, fetchSingleAdjuvants } from "../../actions/Products";
import $ from "jquery";
...
class AdjuvantsProducts extends Component {
  state = {
    search: "",
    name: "",
    email: "",
        ...
        return (
          ...
          >
            <div
              ...
              onClick={() => {
                // trackPromise(this.props.fetchSingleAdjuvants(product._id));
    ...
    return searches
      ...
      .map((search) => {
        ...
        return (
          ...
          >
            {/* <a>{search}</a> */}
            {/* This above line is replaced by the below line */}
            <a href="!#">{search}</a>
          </li>
        );
      });
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw fontSize1">Adjuvants & PH Balancer</h1>
            <h3
              className="fontSize3"
              style={{ color: "#fff", fontSize: "1.8rem", marginTop: "1rem" }}
            >
              Improves the performance of nutrients, Insecticides, Fungicides
              with better absorption capacity.
            </h3>
          </div>
        </div>
          ...
          <div className="container">
            <div className="gallery-filter mb-30 f1">
              <ul className="post-filter masonary text-center list-inline text-capitalize">
                ...
                <li className="filter active list" data-filter="Adjuvants">
