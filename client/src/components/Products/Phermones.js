...
class Pheromones extends Component {
  state = {
    search: "",
    name: "",
    email: "",
  ...
  renderSearchList() {
    ...
    this.props.products.map((product) => {
      ...
      //The above replaced by the below line
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  {/* <a
                    ...
                    href="https://drive.google.com/file/d/1XBHt18DzJ6DLLkLn27T3cd8JKBaZzum4/view?usp=sharing"
                    target="_blank"
                  >
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw fontSize1">Pheromones</h1>
            <h3
              className="fontSize3"
