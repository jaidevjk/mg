...
class BioProducts extends Component {
  state = {
    search: "",
    name: "",
    email: "",
        ...
        return (
          ...
          >
            <div
              ...
              onClick={() => {
                // trackPromise(this.props.fetchSingleBioProduct(product._id));
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  {/* <a
                    ...
                    href="https://drive.google.com/file/d/14v8C66bTE1_NxSKumyQoQdlafTGutCrE/view?usp=sharing"
                    target="_blank"
                  >
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw fontSize1">Bio Products</h1>
            <h3
              className="fontSize3"
              style={{ color: "#fff", fontSize: "1.8rem", marginTop: "1rem" }}
            >
              Bio-fertilisers, Bio-pesticides, Bio-stimulants and Bio-activators
              have been widely accepted as an alternate for improper use of
              chemicals to cultivate organic produce.
            </h3>
          </div>
        </div>
          ...
          <div className="container">
            <div className="gallery-filter mb-30 f1">
              <ul className="post-filter masonary text-center list-inline text-capitalize">
                ...
                <li className="list filter active" data-filter="all">
                  <span className="fw-7">All</span>
                </li>
                <li className="list filter " data-filter="Fertilizers">
                  <span className="fw-7">Bio Fertilizers</span>
                </li>
                <li className="list filter " data-filter="Consortium">
                  <span className="fw-7">Bio-Fertilizers Consortium</span>
                </li>
                <li className="list filter " data-filter="Pesticides">
                  <span className="fw-7">Bio Pesticides</span>
                </li>
                <li className="list filter " data-filter="Fertilizer">
                  <span className="fw-7">Organic Fertilizer</span>
                </li>
              </ul>
            </div>
