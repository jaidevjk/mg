...
import { fetchPesticides, fetchSinglePesticide } from "../../actions/Products";
        ...
        return (
          ...
          >
            <div
              ...
              onClick={() => {
                // trackPromise(this.props.fetchSinglePesticide(product._id));
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  {/* <a
                    ...
                    href="https://drive.google.com/file/d/1wAwwPOrRYhn7pEEYbwCEzCHjUUDZHr-_/view?usp=sharing"
                    target="_blank"
                  >
      ...
      <div>
        ...
        <div className="op-header">
          <div className=" section-header  section-header1 text-center">
            ...
            <h1 className="f1 fw-7 cw fontSize1">Pesticides</h1>
            <h3
              className="fontSize3"
              style={{ color: "#fff", fontSize: "1.8rem", marginTop: "1rem" }}
            >
              Plant protection becomes critical to control unwanted insects,
              pests and weeds.
            </h3>
          </div>
        </div>
          ...
          <div className="container">
            <div className="gallery-filter mb-30 f1">
              <ul className="post-filter masonary text-center list-inline text-capitalize">
                ...
                <li className="filter active list" data-filter="all">
                  <span className="fw-7">All</span>
                </li>
                <li className="filter list " data-filter="Insecticides">
                  <span className="fw-7">Insecticides</span>
                </li>
                <li className="filter  list" data-filter="Fungicides">
                  <span className="fw-7">Fungicides</span>
                </li>
                <li className="filter  list" data-filter="Weedicides">
                  <span className="fw-7">Weedicides</span>
                </li>
                <li className="filter  list" data-filter="Bactericides">
                  <span className="fw-7">Bactericides</span>
                </li>
              </ul>
              {/* <!-- /.post-filter --> */}
            </div>
